...
Page({
  ...
  processData:function(res){
    let movie = {};
    movie.movieImg = res.data.images.large;
    ...
    movie.img = [];
    movie.img[0] = res.data.casts[0].avatars.large;
    movie.img[1] = res.data.casts[1].avatars.large;
    movie.img[2] = res.data.casts[2].avatars.large;
